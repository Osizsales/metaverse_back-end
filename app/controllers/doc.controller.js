...
exports.createDocInfo = async (req, res) => {
  try {
    ...
    // let context = String(pdfExtract.text).replace("\n", "").trim();
    // console.log("pdfExtract", context);

    // const pyPro = spawn("python", [pythonPath, docsContent]);
    // pyPro.stdout.on("data", function (data) {
    //   console.log("result", data.toString());
    // });
    // const index = pinecone.Index("metaverse");

    // await PineconeStore.fromDocuments(docsCcdontent, embeddings, {
    //   pineconeIndex: index,
    //   namespace: req.body.fileName,
    //   textKey: "user",
    // });
